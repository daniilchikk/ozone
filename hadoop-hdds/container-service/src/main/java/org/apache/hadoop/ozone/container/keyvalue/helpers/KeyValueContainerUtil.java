...
public final class KeyValueContainerUtil {
  ...
  /**
   * Moves container directory to a new location under "<volume>/hdds/<cluster-id>/tmp/deleted-containers"
   ...
   * <ol>
   * <li>Container is marked DELETED
   * <li>Container is removed from memory container set
   * <li>Container DB handler from cache is removed and closed
   * <li>Container directory renamed to tmp directory.
   * <li>Container is deleted from tmp directory.
   * </ol>
   * Delete operation for Schema V3
   * <ol>
   * <li>Container is marked DELETED
   * <li>Container is removed from memory container set
   * <li>Container from DB is removed
   * <li>Container directory renamed to tmp directory.
   * <li>Container is deleted from tmp directory.
   * </ol>
   */
